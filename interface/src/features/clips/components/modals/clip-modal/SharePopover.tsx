			...
			<PopoverContent className="w-72 p-3">
				...
				<div className="flex items-center justify-between py-1.5">
					<div className="flex items-center gap-2">
						<img
							...
							className="h-4 w-4"
						/>
						<span className="mb-0.5 text-sm">Discord message</span>
					</div>
				...
				<div className="flex items-center justify-between py-1.5">
					<div className="flex items-center gap-2">
						...
						<span className="mb-0.5 text-sm">Site link</span>
					</div>
					<div className="flex items-center gap-1.5">
						<Button
							size="sm"
...
function CopyButton({
	...
	return (
		<Button
			...
			className={cn(
				"relative border-1 border-transparent transition-colors",
				copied
		...
		>
			<Check
				className={cn("h-4 w-4", copied ? "opacity-100" : "opacity-0")}
			/>
			<Copy
				className={cn(
					"absolute h-4 w-4",
