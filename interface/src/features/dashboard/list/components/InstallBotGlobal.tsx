...
export function InstallBot() {
	...
	return (
		<div
			className="border-accent/50 bg-accent/25 group/install flex flex-1 flex-col items-center gap-8 rounded border px-2 py-8"
...
function InstallPlusIcon({ hovered }: { hovered: boolean }) {
	return (
		<a href={`/api/discord/bot/invite`}>
			<div
				className="my-4 flex items-center gap-2 rounded-full p-6 transition-colors duration-200"
				style={{
