		...
		<form onSubmit={handleSubmit} className="space-y-6">
			...
			{Object.keys(validationErrors).length > 0 && (
				<div className="rounded-lg border border-orange-500/20 bg-orange-500/10 p-4">
					...
					<ul className="list-inside list-disc space-y-1 text-sm text-orange-400">
			...
			<section className="space-y-4 rounded-lg border border-white/20 p-6">
				...
				{Object.entries(guildSettingsMetadata).some(
					...
					<>
						<div className="mt-6 border-t border-white/10 pt-4">
							<p className="-mt-7 mb-4 text-center text-sm tracking-wider text-gray-300 uppercase">
								Advanced Settings
							</p>
							<div className="space-y-4">
								{Object.entries(guildSettingsMetadata)
			...
			<div className="flex flex-wrap items-center gap-3">
				<button
					...
					className="rounded-lg bg-blue-600 px-6 py-2 text-white transition-colors hover:bg-blue-700 disabled:cursor-not-allowed disabled:bg-gray-600"
				>
				...
				<button
					...
					onClick={reset}
					disabled={!hasChanges || saving}
					className="rounded-lg border border-white/20 px-6 py-2 transition-colors hover:bg-white/5 disabled:cursor-not-allowed disabled:opacity-50"
				>
					Reset
				</button>
				<button
					...
					disabled={saving}
					className="rounded-lg border border-red-500/50 px-6 py-2 text-red-400 transition-colors hover:bg-red-500/10 disabled:cursor-not-allowed disabled:opacity-50"
				>
					Reset to Defaults
				</button>
				{hasChanges && (
